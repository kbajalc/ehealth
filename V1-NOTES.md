...
- [e-Health Sensor Platform V1 — Notes \& Errata](#e-health-sensor-platform-v1--notes--errata)
  ...
  - [3. Installing the Libraries in Arduino IDE 2.3.8](#3-installing-the-libraries-in-arduino-ide-238)
    - [Method A — Manual copy (recommended, no ZIP needed)](#method-a--manual-copy-recommended-no-zip-needed)
    - [Method B — ZIP install via IDE](#method-b--zip-install-via-ide)
  ...
  - [5. Sensor-by-Sensor V1 Errata](#5-sensor-by-sensor-v1-errata)
    - [5.1 SPO2 / Pulse Oximeter](#51-spo2--pulse-oximeter)
    - [5.2 ECG — No Jumper Selection Needed](#52-ecg--no-jumper-selection-needed)
    - [5.3 EMG — Not Present on V1](#53-emg--not-present-on-v1)
    - [5.4 Blood Pressure — Wrist Cuff, Different API](#54-blood-pressure--wrist-cuff-different-api)
      - [Key differences from GUIDE.md (V2)](#key-differences-from-guidemd-v2)
      - [Jumper setup](#jumper-setup)
    ...
    - [5.5 Patient Position — Jumper Required](#55-patient-position--jumper-required)
    - [5.6 Body Temperature — Calibration](#56-body-temperature--calibration)
    - [5.7 GSR / Skin Conductance — Calibration](#57-gsr--skin-conductance--calibration)
    - [5.8 Glucometer — 32 Records, P-C Indicator](#58-glucometer--32-records-p-c-indicator)
    - [5.9 All Other Sensors](#59-all-other-sensors)
  - [6. GLCD Display Library](#6-glcd-display-library)
    - [Three display screens](#three-display-screens)
    - [Including the library](#including-the-library)
    - [API functions](#api-functions)
    - [Complete GLCD example](#complete-glcd-example)
